...
version 4, raid ruleset version 7). It covers authentication, sessions, the exclusive writer
...
- `/raid/finish` requires a matching `rulesetVersion` (`RAID_RULESET_VERSION = 7`; a mismatch
